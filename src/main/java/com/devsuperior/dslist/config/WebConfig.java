...
// Difino quais endereços url(web,sites), estão autorizado a acessar este backend.
...
// caso configurar adicionar variavel de ambiente [ CORS_ORIGINS:https//: nome.dominios] - isso libera o meu navegador, apenas para este dominio poder acessar.
